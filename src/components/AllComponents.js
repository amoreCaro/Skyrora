...
export default function AllComponents({ attributes, setAttributes }) {
  ...
  return (
    <div class={containerStyle}>
      ...
      {getField("paragraph", 1, "A close look at thework carried out by Skyrora over the last few months", setAttributes, undefined, "", "18px", "30px", "40px", true)}
      ...
      {getField("paragraph", 1, "This year has tested us in ways we could never have imagined, yet it has also reinforced our unity and purpose. Your hard work and perseverance inspire me every day, and I am immensely proud of what we have achieved despite the uncertainty and fear that surround us.", setAttributes, undefined)}
      {getField("paragraph", 1, "Let us look to 2025 with hope and determina-tion. May it bring peace to those in Ukraine, stability to our operations, and continued strength to our team. Together, we can achieve greatness, no matter the obstacles.", setAttributes, undefined)}
