...
export default function AllComponents({ attributes, setAttributes }) {
  ...
  return (
    <div class={containerStyle}>
      ...
      {getField("heading", 1, "A letter from our ceo", setAttributes, undefined, "h3", "0px", "12px")}
      {getField("paragraph", 1, "Dear Skyrora!", setAttributes, undefined, "16px", "0px", "12px")}
      {getField("paragraph", 1, "As we bid farewell to another year, I am reminded of the extraordinary challenges we have faced and overcome together. Whether in the UK or Ukraine, each of you has shown remarkable courage, resilience, and dedication.", setAttributes, undefined, "16px", "0px", "0px")}
      {getField("paragraph", 1, "This year has tested us in ways we could never have imagined, yet it has also reinforced our unity and purpose. Your hard work and perseverance inspire me every day, and I am immensely proud of what we have achieved despite the uncertainty and fear that surround us.", setAttributes, undefined, "16px", "0px", "12px")}
      {getField("paragraph", 1, "Let us look to 2025 with hope and determina-tion. May it bring peace to those in Ukraine, stability to our operations, and continued strength to our team. Together, we can achieve greatness, no matter the obstacles.", setAttributes, undefined, "16px", "0px", "12px")}
      {getField("paragraph", 1, "Wishing you and your families a New Year filled with hope, health, and happiness.", setAttributes, undefined, "16px", "0px", "12px")}
      {getField("paragraph", 1, "With gratitude and respect, ", setAttributes, undefined, "16px", "0px", "0px")}
      {getField("paragraph", 1, "Volodymyr Levykin,", setAttributes, undefined, "16px", "0px", "0px")}
      {getField("paragraph", 1, "CEO Skyrora", setAttributes, undefined, "16px", "0px", "0px")}
